module.exports = {
    ...
    DATABASE_URL: process.env.DATABASE_URL || 'postgresql://dunder_mifflin@localhost/lgbtq',
    TEST_DATABASE_URL: process.env.TEST_DATABASE_URL || 'postgresql://dunder_mifflin@localhost/lgbtq-test',
